...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "Add": return _U.update(model,
         ...
         case "Clear": return _U.update(model,{todos: A2($List.filter,function (todo) {    return _U.eq(todo.completed,false);},model.todos)});
         case "Complete": var _p1 = _p0._0;
           var updateTodo = function (thisTodo) {    return _U.eq(thisTodo.identifier,_p1.identifier) ? _U.update(_p1,{completed: true}) : thisTodo;};
           return _U.update(model,{todos: A2($List.map,updateTodo,model.todos)});
         case "Uncomplete": var _p2 = _p0._0;
           var updateTodo = function (thisTodo) {    return _U.eq(thisTodo.identifier,_p2.identifier) ? _U.update(_p2,{completed: false}) : thisTodo;};
           return _U.update(model,{todos: A2($List.map,updateTodo,model.todos)});
         case "Delete": return _U.update(model,
           {todos: A2($List.filter,function (mappedTodo) {    return !_U.eq(_p0._0.identifier,mappedTodo.identifier);},model.todos)});
         case "Filter": return _U.update(model,{filter: _p0._0});
         case "UpdateTitle": var todo = model.todo;
           var updatedTodo = _U.update(todo,{title: _p0._0});
           return _U.update(model,{todo: updatedTodo});
   ...
   var Add = {ctor: "Add"};
   var NoOp = {ctor: "NoOp"};
   var handleKeyPress = function (code) {    var _p6 = code;if (_p6 === 13) {    return Add;} else {    return NoOp;}};
